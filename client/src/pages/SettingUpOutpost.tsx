...
export default function SettingUpOutpost() {
  useDocumentTitle("Setting Up Your Outpost — Relay Outpost");
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8 animate-in fade-in duration-300">
      ...
      <div className="mb-8">
        <div className="rounded-xl border border-border/30 dark:border-border/15 bg-white/50 dark:bg-muted/10 p-5">
          <p className="text-sm text-foreground/70 dark:text-muted-foreground leading-relaxed">
            Outposts are communities built around a relay — your crew's home base on the open social web. This guide walks you through discovering communities, joining your first Outpost, and making it your own. Whether you're looking for a niche interest group or building one from scratch, this is where it starts.
          </p>
      ...
      <div className="space-y-6">
        <StepCard
          ...
          description={
            <>
              <p>Outposts spread person to person — you find them through people, not a catalog:</p>
              <ul className="list-disc list-inside space-y-1 text-[13px] text-foreground/60">
                ...
                <li>Preview an Outpost's timeline before joining</li>
              </ul>
              <p className="text-[12px] text-foreground/50">Outposts are built on relays — each one is its own independent community with its own culture and rules.</p>
            </>
          }
        />
        ...
        <StepCard
          number={2}
          title="Join Your First Outpost"
          icon={Users}
          description={
            <>
              <p>Found a community that resonates? Joining is one tap. Here's what happens:</p>
              <ul className="list-disc list-inside space-y-1 text-[13px] text-foreground/60">
                <li>Open the Outpost and tap <strong>Join</strong> in its header — private communities say <strong>Request</strong>, and the operator approves</li>
                <li>The relay is added to your relay list automatically</li>
                <li>You'll start seeing Outpost content in your feeds</li>
                <li>Your posts can now be broadcast to that community's relay</li>
              </ul>
              <p className="text-[12px] text-foreground/50">You can join as many Outposts as you like — each one adds a new dimension to your network.</p>
            </>
          }
        />
        ...
        <StepCard
          number={3}
          title="Explore Outpost Sections"
          icon={Layers}
          description={
            <>
              <p>Every Outpost is more than just a feed. Each one comes with built-in sections designed for different types of interaction:</p>
              <ul className="list-disc list-inside space-y-1 text-[13px] text-foreground/60">
        ...
        <StepCard
          number={4}
          title="Post to Your Outpost"
          icon={PenLine}
          description={
            <>
              <p>Ready to contribute? When you're inside an Outpost, your posts are broadcast to that community's relay.</p>
              <ul className="list-disc list-inside space-y-1 text-[13px] text-foreground/60">
                <li>Write a note in the Outpost's timeline — it goes to members of that relay</li>
        ...
        <StepCard
          ...
          description={
            <>
              <p>Each Outpost is powered by a relay. Understanding your relay connection gives you more control:</p>
              <ul className="list-disc list-inside space-y-1 text-[13px] text-foreground/60">
        ...
        <StepCard
          number={6}
          title="Run Your Own Outpost (optional)"
          icon={Globe}
          description={
            <>
              <p>Most people simply <strong>join</strong> outposts — that's the whole experience. But if you run a relay (or want to), you can host your own. <Link href="/help/relay-communities" className="text-brand underline underline-offset-2">Learn how relay communities work →</Link></p>
              <ul className="list-disc list-inside space-y-1 text-[13px] text-foreground/60">
                <li>Add your relay's address on the <strong>Communities</strong> page — it becomes your Outpost</li>
                <li>Open <strong>Manage</strong> inside your Outpost to configure it</li>
              ...
              <p className="text-[12px] text-foreground/50">Running your own relay is the technical path — it gives you complete control over your community's data and moderation. No relay? Just join the outposts you love.</p>
            </>
          }
        />
        ...
        <StepCard
          ...
          description={
            <>
              ...
              <p className="text-[12px] text-foreground/50">Relay Control gives operators full visibility into their relay — the backbone of their Outpost community.</p>
            </>
          }
        />
      </div>
      ...
      <div className="mt-10 mb-6">
        <div className="rounded-xl border border-border/30 dark:border-border/15 bg-gradient-to-br from-brand/[0.03] to-brand/[0.02] p-6 text-center">
          ...
          <h3 className="text-sm font-bold text-foreground/80 mb-1">Your Outpost awaits</h3>
          <p className="text-xs text-muted-foreground/50 max-w-sm mx-auto leading-relaxed mb-4">
            Whether you're joining an existing community or building your own, Outposts are where the open social web comes alive. Find your people, share your signal, build your home.
          </p>
